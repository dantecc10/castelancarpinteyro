...
<head>
    ...
    <title>Equipo - Castelán Carpinteyro</title>
        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <p class="fw-bold text-success mb-2">Soporte y desarrollo</p>
                    <h2 class="fw-bold">Equipo</h2>
                    <p class="text-muted w-lg-50">Este es el equipo que hace posible todo en <strong><em>Castelán Carpinteyro</em></strong>.</p>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <h2 class="fw-bold"><strong>Equipo</strong></h2>
                ...
                <div class="col mb-4">
                    <div class="d-flex flex-column align-items-center align-items-sm-start">
                        ...
                        <div class="d-flex"><img class="rounded-circle flex-shrink-0 me-3 fit-cover" width="50" height="50" src="../assets/img/team/avatar2.jpg">
                            <div>
                                <p class="fw-bold text-primary mb-0">Jeremy Hernandez</p>
