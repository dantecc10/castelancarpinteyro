            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">Software</p>
            ...
            <div class="row pt-5">
                <div class="col">
                    ...
                    <form method="get" action="php scripts/create-qr.php">
                        <div class="input-group col-12"><span class="input-group-text">URL</span><input class="form-control" type="url" name="url" required=""><button class="btn btn-primary" type="button">Button</button></div><button class="btn btn-primary div2-efecto" type="button">¡Generar código QR!</button>
                    </form>
                </div>
            </div>
