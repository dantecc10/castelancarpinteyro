                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form id="loginForm" action="php-scripts/login.php" method="post">
                                <div class="mb-3"><input class="form-control" id="emailInput" type="email" name="email" placeholder="Email" <?php
                                                                                                                                            if (isset($_GET['email'])) {
                                                                                                                                                echo (" value='" . $_GET['email'] . "'");
                                                                                                                                            }
                                                                                                                                            ?>></div>
                                <div class="mb-3"><input class="form-control" id="passwordInput" type="password" name="password" placeholder="Contraseña" <?php
