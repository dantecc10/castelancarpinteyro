...
<head>
    ...
    <title>Cuenta - Castelán Carpinteyro</title>
                ...
                <div class="row mb-3">
                    <div class="col-lg-4">
                                    ...
                                    <form action="php-scripts/change_image.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <style>
                                            .input-label {
                                                ...
                                                cursor: pointer;
                                                /* Agrega este estilo para que el cursor cambie al hacer clic en la etiqueta */
                                            }
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h4 class="small fw-bold">Avance en cursos<span class="float-end">20%</span></h4>
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar bg-danger" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"><span class="visually-hidden">20%</span>
                                    </div>
                                </div>
                                <h4 class="small fw-bold">Artículos publicados<span class="float-end">40%</span></h4>
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar bg-warning" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;"><span class="visually-hidden">40%</span>
                                    </div>
                                </div>
                                <h4 class="small fw-bold">Información de contacto<span class="float-end">60%</span></h4>
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar bg-primary" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"><span class="visually-hidden">60%</span>
                                    </div>
                                </div>
                                <h4 class="small fw-bold">Mensajes<span class="float-end">80%</span></h4>
                                <div class="progress progress-sm mb-3">
                                    <div class="progress-bar bg-info" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 80%;"><span class="visually-hidden">80%</span>
                                    </div>
                                </div>
                                <h4 class="small fw-bold">Información de cuenta<span class="float-end">Complete!</span></h4>
                                <div class="progress progress-sm mb-3">
                        ...
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="php-scripts/save-account-changes.php">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="last_name1">
                                                            <strong>Apellido
                                                                paterno</strong>
                                                        </label>
                                                ...
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="last_name2">
                                                            <strong>Apellido
                                                                materno</strong>
                                                            <br>
                                                        </label>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="mb-3"><label class="form-label" for="address"><strong>Dirección</strong></label><input id="address" class="form-control" type="text" placeholder="Sunset Blvd, 38" name="address" /></div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3"><label class="form-label" for="city"><strong>Ciudad</strong></label><input id="city" class="form-control" type="text" placeholder="Los Angeles" name="city" /></div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                ...
                <div class="card shadow mb-5">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <form>
                                    <div class="mb-3"><label class="form-label" for="signature"><strong>Firma</strong><br /></label><textarea id="signature" class="form-control" rows="4" name="signature"></textarea></div>
                                    <div class="mb-3">
                                        <div class="form-check form-switch"><input id="formCheck-1" class="form-check-input" type="checkbox" /><label class="form-check-label" for="formCheck-1"><strong>Notifícame sobre
        ...
        <div class="container py-4 py-lg-5">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item"><a href="https://instagram.com/dantecc10" target="_blank"><svg class="bi bi-instagram" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
