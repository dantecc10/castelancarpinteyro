...
<head>
    ...
    <title>Carta a mis padres - Dante Castelán Carpinteyro</title>
            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">24 de enero del 2023</p>
                        <h1 class="fw-bold">Carta a mis padres</h1>
                        <p class="text-muted w-lg-50"><strong><span style="color: rgb(255, 255, 255);">Dante Castelán
                                    Carpinteyro</span></strong><br></p>
                    </div>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col">
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Hola, papás:
                        </span><br></p>
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Aquí Dante Castelán Carpinteyro su hijo.
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Si bien la junta de padres de familia es a
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Esta carta es generada a través de un
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Me percibo en soledad; en inmensa soledad
                            porque casi nadie sabe de qué hablo y adoro hablar de código y programación.
                        </span><br></p>
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Estamos en un punto en el que para ustedes
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Tengo que agradecer su participación en
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Es claro que soy mucho, he evolucionado
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Les diría en quejas y sugerencias, que por
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">No sé si quiero mayor o menor interacción
                            social con ustedes, pero sin duda quiero que sea de calidad.
                        </span><br></p>
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Creo que lo que haga ahora, con mi vida,
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">No me veo teniendo éxito y disfrutándolo
                            sin que ustedes estén ahí, conmigo, respaldándome.
                        </span><br></p>
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Es por eso que quiero expresarles mi
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Creo, también que quiero seguir siendo
                    ...
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Si bien me encanta tratar de ser siempre
                            el mejor en todo, no hay nada que haga por hacerme daño o a ustedes.
                        </span><br></p>
                    <p class="sangría" style="text-align: justify;"><span
                            style="background-color: rgba(248, 249, 250, 0);">Seamos felices, permítanme crecer para
                            retribuir a la familia lo que he recibido.</span><br></p>

                    <p class="text-end" style="text-align: justify;"><strong><em><span
                                    style="background-color: rgba(248, 249, 250, 0);">Jamás duden de lo mucho que los
