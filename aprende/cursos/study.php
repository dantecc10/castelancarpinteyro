...
<head>
    ...
    <title>Estudiar curso - Castelán Carpinteyro</title>
    ...
    <section class="py-5">
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col">
                    <h1 class="md-4 fw-bold">Curso</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-lg-10 offset-lg-0 justify-content-center">
                    <header class="text-center">
                        <h2 id="title-lesson" class="fw-bold">Heading</h2>
                    </header><iframe allowfullscreen="" frameborder="0" width="100%" height="395"
                        src="https://www.youtube.com/embed/q7jx98pKKlk" title="YouTube video player"
                        allow="accelerometer; autoplay; clipboard-write; encrypted media; gyroscope; picture-in-picture; web-share"></iframe>
                    <div class="justify-content-center" style="overflow-x: auto;display: flex;">
                        <nav class="dataTables_paginate paging_simple_numbers">
                            <ul class="pagination">
                                ...
                                <li class="page-item" id="cintaP"><a class="page-link" href="#">1</a></li>
                                <li class="page-item" id="cintaT"><a class="page-link" href="#">1</a></li>
                                <li class="page-item" id="cinta1"><a class="page-link" href="#">1</a></li>
                                <li class="page-item" id="cinta2"><a class="page-link" href="#">2</a></li>
                                <li class="page-item" id="cinta3"><a class="page-link" href="#">3</a></li>
                                <li class="page-item" id="cinta4"><a class="page-link" href="#">4</a></li>
                                <li class="page-item" id="cintaE"><a class="page-link" href="#">5</a></li>
                                <li class="page-item" id="cintaC"><a class="page-link" href="#">5</a></li>
                        ...
                        <div class="row pt-5">
                            <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                                <div class="text-center">
                                    <h1 class="fw-bold">Curso 1</h1>
                                    <p class="fw-bold text-success mb-2">Jeremy Hernández Balderas</p>
                                </div>
                            </div>
                        </div>
                        <p class="text-indent">Lorem Ipsum dolor sit amet cuncta stricte stricte discusurus dies irae
                            dies illa solvet saeclum in favilla teste David cum Sybilla. Cuantus tremor est futurus
                            quando iudex este venturus cuncta stricte discusurus.</p>
                    </div>
                    <div class="container d-flex justify-content-center mt-1 mb-4">
                        <div class="btn-group order-group-button" role="group" aria-label="Botones de navegación"
                            style="width: auto;height: auto;max-width: 100%;"><button
                                class="btn btn-secondary nav-gradient-button nav-button" id="previous-nav-button"
                                type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512"
                                    width="1em" height="1em" fill="currentColor">
                                    <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                    <path
                                        d="M447.1 256C447.1 273.7 433.7 288 416 288H109.3l105.4 105.4c12.5 12.5 12.5 32.75 0 45.25C208.4 444.9 200.2 448 192 448s-16.38-3.125-22.62-9.375l-160-160c-12.5-12.5-12.5-32.75 0-45.25l160-160c12.5-12.5 32.75-12.5 45.25 0s12.5 32.75 0 45.25L109.3 224H416C433.7 224 447.1 238.3 447.1 256z">
                                    </path>
                                </svg>&nbsp;Anterior</button><button
                                class="btn btn-secondary nav-complete-gradient nav-button" id="complete-nav-button"
                                type="button" style="padding: 9.6px 10px;">Completar<svg
                                ...
                                </svg></button><button class="btn btn-secondary nav-gradient-button nav-button"
                                id="next-nav-button" type="button">Siguiente&nbsp;<svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em"
                                    fill="currentColor">
                                    <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                    <path
                ...
                <div class="col-md-6 col-lg-2 text-center">
                    <ul data-bss-hover-animate="pulse" class="lateral-efecto"
                        style="list-style-type: none;padding-left: 0px;border-radius: 10px;">
                        <li id="lateralP" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg>&nbsp;<a href="#">Presentación</a></li>
                        <li id="lateralT" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="-192 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                            ...
                            </svg>&nbsp;<a href="#">Temario</a></li>
                        <li id="lateral1" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                            ...
                            </svg>&nbsp;<a href="#">Lección 1</a></li>
                        <li id="lateral2" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                                    d="M0 219.2v212.5c0 14.25 11.62 26.25 26.5 27C75.32 461.2 180.2 471.3 240 511.9V245.2C181.4 205.5 79.99 194.8 29.84 192C13.59 191.1 0 203.6 0 219.2zM482.2 192c-50.09 2.848-151.3 13.47-209.1 53.09C272.1 245.2 272 245.3 272 245.5v266.5c60.04-40.39 164.7-50.76 213.5-53.28C500.4 457.9 512 445.9 512 431.7V219.2C512 203.6 498.4 191.1 482.2 192zM352 96c0-53-43-96-96-96S160 43 160 96s43 96 96 96S352 149 352 96z">
                                </path>
                            </svg>&nbsp;<a href="#">Lección 2</a></li>
                        <li id="lateral3" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                                    d="M0 219.2v212.5c0 14.25 11.62 26.25 26.5 27C75.32 461.2 180.2 471.3 240 511.9V245.2C181.4 205.5 79.99 194.8 29.84 192C13.59 191.1 0 203.6 0 219.2zM482.2 192c-50.09 2.848-151.3 13.47-209.1 53.09C272.1 245.2 272 245.3 272 245.5v266.5c60.04-40.39 164.7-50.76 213.5-53.28C500.4 457.9 512 445.9 512 431.7V219.2C512 203.6 498.4 191.1 482.2 192zM352 96c0-53-43-96-96-96S160 43 160 96s43 96 96 96S352 149 352 96z">
                                </path>
                            </svg>&nbsp;<a href="#">Lección 3</a></li>
                        <li id="lateral4" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                                    d="M0 219.2v212.5c0 14.25 11.62 26.25 26.5 27C75.32 461.2 180.2 471.3 240 511.9V245.2C181.4 205.5 79.99 194.8 29.84 192C13.59 191.1 0 203.6 0 219.2zM482.2 192c-50.09 2.848-151.3 13.47-209.1 53.09C272.1 245.2 272 245.3 272 245.5v266.5c60.04-40.39 164.7-50.76 213.5-53.28C500.4 457.9 512 445.9 512 431.7V219.2C512 203.6 498.4 191.1 482.2 192zM352 96c0-53-43-96-96-96S160 43 160 96s43 96 96 96S352 149 352 96z">
                                </path>
                            </svg>&nbsp;<a href="#">Lección 4</a></li>
                        <li id="lateralE" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
                            ...
                            </svg>&nbsp;<a href="#">Evaluación</a></li>
                        <li id="lateralC" class="elementoLateral"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                <path
