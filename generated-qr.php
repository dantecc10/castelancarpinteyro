            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        <p class="fw-bold text-success mb-2">¡Listo!</p>
                        <h1 class="fw-bold">Generador de códigos QR</h1>
                        <p class="text-muted w-lg-50"><strong><span style="color: rgb(255, 255, 255);">Por Dante Castelán Carpinteyro</span></strong><br></p>
                    </div>
                </div>
            </div>
            <div class="row pt-5">
                <div class="col">
                    <div class="row">
                        <div class="col">
                            <p class="sangría" style="text-align: justify;"><span style="background-color: rgba(248, 249, 250, 0);">Aquí tienes tu código QR para el link que necesitas. Descárgalo y pruébalo. ¿Necesitas otro? </span><a href="qr-code.php"><span style="background-color: rgba(248, 249, 250, 0);">Da click aquí</span></a><span style="background-color: rgba(248, 249, 250, 0);">.</span><br></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col text-center btn btn-primary div2-efecto"><a href="generated-qrs/<?php echo ($qr_name);?>" download="<?php echo ($qr_name);?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
