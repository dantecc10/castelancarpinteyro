                        ...
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-5 px-md-5">
                                ...
                                <p class="text-muted card-text mb-4">Erat netus est hendrerit, nullam et quis ad cras
                                    porttitor iaculis. Bibendum vulputate cras aenean.</p><button class="btn btn-primary shadow" type="button">Learn more</button>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" method="post">
                            ...
                            <div><button class="btn btn-primary shadow d-block w-100" type="submit">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
