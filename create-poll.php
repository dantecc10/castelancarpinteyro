...
<head>
    ...
    <title>¡Enlace generado! - Castelán Carpinteyro</title>
            ...
            <div class="row pt-5">
                <div class="col-md-8 col-xl-6 text-center text-md-start mx-auto">
                    <div class="text-center">
                        ...
                        <h1 class="fw-bold">Generador de enlaces d encuestas</h1>
