...
<head>
    ...
    <title>Verificación en dos pasos - Castelán Carpinteyro</title>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            <div class="bs-icon-xl bs-icon-circle bs-icon-primary shadow bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor" data-bss-hover-animate="jello">
                            ...
                            <form id="clave" method="post" action="php-scripts/jsInputPHP.php">
                                <div class="justify-content-between align-content-center align-self-center mb-3 key-inputs">
                                    <div class="text-center d-inline-flex flex-grow-1 justify-content-between" data-bs-toggle="tooltip" data-bss-tooltip="">
                                        ...
                                        <input id="input2" name="2" onkeyup="javascript:codeSend(2);" type="number" class="form-control form-control-lg flex-shrink-1 flex-fill flex-nowrap" data-bs-toggle="tooltip" data-bss-tooltip="" step="any" min="0" max="9" maxlength="1" required style="padding-right: 7px;padding-left: 7px;text-align: center;margin: 0px 2.5px 0px 2.5px;border-radius: 40%;width: 100%;height: 80%;">
                                        <input id="input3" name="3" onkeyup="javascript:codeSend(3);" type="number" class="form-control form-control-lg flex-shrink-1 flex-fill flex-nowrap" data-bs-toggle="tooltip" data-bss-tooltip="" step="any" min="0" max="9" maxlength="1" required style="padding-right: 7px;padding-left: 7px;text-align: center;margin: 0px 2.5px 0px 2.5px;border-radius: 40%;width: 100%;height: 80%;">
                                        <input id="input4" name="4" onkeyup="javascript:codeSend(4);" type="number" class="form-control form-control-lg flex-shrink-1 flex-fill flex-nowrap" data-bs-toggle="tooltip" data-bss-tooltip="" step="any" min="0" max="9" maxlength="1" required style="padding-right: 7px;padding-left: 7px;text-align: center;margin: 0px 2.5px 0px 2.5px;border-radius: 40%;width: 100%;height: 80%;">
                                        <input id="input5" name="5" onkeyup="javascript:codeSend(5);" type="number" class="form-control form-control-lg flex-shrink-1 flex-fill flex-nowrap" data-bs-toggle="tooltip" data-bss-tooltip="" step="any" min="0" max="9" maxlength="1" required style="padding-right: 7px;padding-left: 7px;text-align: center;margin: 0px 2.5px 0px 2.5px;border-radius: 40%;width: 100%;height: 80%;">
                                        <input id="input6" name="6" onkeyup="javascript:codeSend(6);" type="number" class="form-control form-control-lg flex-shrink-1 flex-fill flex-nowrap" data-bs-toggle="tooltip" data-bss-tooltip="" step="any" min="0" max="9" maxlength="1" required style="padding-right: 7px;padding-left: 7px;text-align: center;margin: 0px 0px 0px 2.5px;border-radius: 40%;width: 100%;height: 80%;">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <input id="email" name="email" class="form-control" type="email" value="<?php echo $email; ?>" hidden required>
                                </div>
                                <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" type="submit"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                                            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                                        ...
                                        </svg>&nbsp;Verificar</button>

                                    <div id="divMensaje" class="mensaje" style="margin: 10px 0px 0px 0px;">
                                        <!-- Aquí queda pendiente adaptar el mensaje de éxito o error -->
                                        <div class="ícono"></div>
                                        <div class="íconoCierre"></div>
                                    </div>

                                </div>
                                <p class="text-muted">Iniciar sesión&nbsp;<a href="login.html">normalmente</a>.</p>
