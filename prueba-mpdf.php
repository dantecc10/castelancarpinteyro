...
$html = ("<body style='/*background: url(&quot;design.jpg&quot;);*/background-position: 0 -60px;'>
    ...
    <div class='container'><a class='navbar-brand d-flex align-items-center' href='/'><span class='bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon rueda-logo'><svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' class='bi bi-code-slash'>
        ...
        <div class='collapse navbar-collapse' id='navcol-1'>
            <ul class='navbar-nav mx-auto'>
                ...
                <li class='nav-item'><a class='nav-link' href='aprende.html'>Aprende a programar</a></li>
                <li class='nav-item'><a class='nav-link' href='servicios.html'>Servicios</a></li>
                <li class='nav-item'><a class='nav-link' href='products.html'>Productos</a></li>
            </ul>
            <div class='div1-efecto'><a class='btn btn-primary shadow div2-efecto' role='button' href='registro.html'>Iniciar sesión</a></div>
        </div>
    </div>
...
<header class='bg-dark'>
    ...
    <div class='container pt-4 pt-xl-5'>
        <div class='row pt-5'>
            ...
            <div class='col-12 col-lg-10 mx-auto align-items-center'><div class='contenedor'>
...
<div class='terminal_toolbar'>
    ...
    <p class='user-terminal'>dantedev@admin: ~</p>
</div>
<div class='terminal_body'>
    <div class='terminal_promt'>
        <span class='terminal_user'>dantedev@admin:</span>
...
<section class='py-5'>
    <div class='container text-center py-5'>
        <p class='mb-4' style='font-size: 1.6rem;'>Cursos acerca de la siguientes tecnologías:</p><a href='#'> <img class='m-3' src='assets/img/brands/google.png'></a><a href='#'> <img class='m-3' src='assets/img/brands/microsoft.png'></a><a href='#'> <img class='m-3' src='assets/img/brands/apple.png'></a><a href='#'> <img class='m-3' src='assets/img/brands/facebook.png'></a><a href='#'> <img class='m-3' src='assets/img/brands/twitter.png'></a>
    </div>
</section><!-- End: Brands -->
<section>
    ...
    <div class='container py-4 py-lg-5'>
        ...
        <div class='text-muted d-flex justify-content-between align-items-center pt-3'>
            ...
            <ul class='list-inline mb-0'>
                ...
                <li class='list-inline-item'><svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' class='bi bi-whatsapp'>
                ...
                <li class='list-inline-item'><svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' fill='currentColor' viewBox='0 0 16 16' class='bi bi-envelope-fill'>
